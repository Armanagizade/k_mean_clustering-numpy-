...
i use a clustering algorithm (k-mean) for select silmilar data(flowers).

![image](https://github.com/user-attachments/assets/fb0daccf-9f6e-4809-8598-db2c635195af)
